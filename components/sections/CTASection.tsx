...
export default function CTASection({ referralCode, onCopyCode }: CTASectionProps) {
  ...
  return (
    <section className="w-full">
      <div className="mx-auto w-fit bg-[#E249AF] py-2 md:py-3 lg:py-4 px-6 md:px-8 lg:px-10 rounded-full flex items-center justify-center gap-2 md:gap-3 lg:gap-4 transition-transform duration-200 ease-out hover:-translate-y-px hover:shadow-[0px_10px_24px_0px_#E249AF55]">
        ...
        <div className="flex flex-col gap-2 md:gap-3">
          ...
          <div className="flex items-center gap-1 md:gap-2">
            <span className="text-white text-xs md:text-sm lg:text-base font-medium">{t('section4.referralCode')}</span>
