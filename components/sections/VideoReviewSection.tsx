...
export default function VideoReviewSection() {
  ...
  // Có thể thêm nhiều video review cards sau này
  const videoReviews = [
    {
      image: "/picture6.jpg",
      avatar: "/picture7.png",
      brand: "MANYO",
      time: "09h 16m 30s",
      product: "Panthetoin Deep Moisture Mask",
  ...
  return (
    <section className="w-full">
      <div className="flex flex-col gap-4 md:gap-6 lg:gap-8">
        ...
        <div
          ref={emblaRef}
          className="overflow-hidden h-[507px] lg:h-[700px] scrollbar-hide"
              ...
              return (
                ...
                >
                  ...
                  <div className="p-3 md:p-4 lg:p-5 flex gap-3 md:gap-4">
                    <Image src={review.avatar} alt="play" width={1000} height={1000} className="w-[60px] md:w-[70px] lg:w-[80px] aspect-60/76 object-contain shrink-0" />
                    <div className="flex flex-col gap-1 md:gap-2 flex-1">
                      <div className="flex items-center gap-1 justify-between">
                        <h3 className="text-[10px] md:text-xs lg:text-sm font-bold text-[#111827]">{review.brand}</h3>
                        <p className="text-[10px] md:text-xs lg:text-sm text-[#4B5563]">{review.time}</p>
                      </div>
                      <p className="text-sm md:text-base lg:text-lg text-[#111827] font-medium">{review.product}</p>
                      ...
                      <p className="text-xs md:text-sm text-[#374151]">{review.participation} {t('section3.participation')}</p>
